...
void Model::compute(int np, int nd, double pos[], double vel[],
...
double Model::dist(int nd, double r1[], double r2[], double dr[])
...
double Model::r8_uniform_01(int *seed)
...
void Model::update(int np, int nd, double pos[], double vel[], double f[],
